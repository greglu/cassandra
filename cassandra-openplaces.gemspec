...
Gem::Specification.new do |s|
  s.name = %q{cassandra-openplaces}
  s.version = "0.8.2"

  s.required_rubygems_version = Gem::Requirement.new(">= 0.8") if s.respond_to? :required_rubygems_version=
  s.authors = ["Evan Weaver, Ryan King, Openplaces"]
  s.date = %q{2010-05-11}
